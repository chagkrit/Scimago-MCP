...
import { researchColumns, ScopusClient, sourceColumns, toResearchCsvRows, toSourceCsvRows, } from "./scopus.js";
import { ScimagoClient, scimagoColumns, scimagoDefaultCategories, scimagoQuartiles, } from "./scimago.js";
...
server.registerTool("scopus_search", {
    title: "Search Scopus",
...
server.registerTool("scopus_search_to_csv", {
...
server.registerTool("scopus_sources_to_csv", {
...
server.registerTool("scimago_health_medicine_journals", {
    title: "Search SCImago Health/Medicine Journals",
    description: "Search SCImago Journal Rank for Q1/Q2 medicine journals in Oncology, Surgery, and Obstetrics and Gynecology.",
...
server.registerTool("scimago_health_medicine_journals_to_csv", {
    title: "Export SCImago Health/Medicine Journals CSV",
    description: "Export Q1/Q2 SCImago medicine journals in Oncology, Surgery, and Obstetrics and Gynecology to CSV.",
    inputSchema: {
        ...ScimagoSchema,
